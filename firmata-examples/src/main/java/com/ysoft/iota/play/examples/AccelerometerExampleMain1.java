 ...
 */
public class AccelerometerExampleMain1 {

    private static final byte LIS3DE_DATARATE_1_HZ = 0x01;
    private static final byte LIS3DE_DATARATE_10_HZ = 0x02;
    private static final byte LIS3DE_DATARATE_100_HZ = 0x05;
    ...
    public static void main(String[] args) throws Exception {
        ...
        value |= (LIS3DE_DATARATE_100_HZ << 4);  // Set sampling interval
